...
class _SearchMoviePageState extends State<SearchMoviePage> {
  ...
  Widget _buildErrorWidget(IconData icon, String message) {
    return Container(
        ...
        child: Column(
          ...
          children: [
            Padding(
              padding: EdgeInsets.symmetric(vertical: ScreenManager.hp(2.5)),
              child: Icon(
                icon,
  ...
  Widget _buildErrorMessage(String errorMsg) {
    return _buildErrorWidget(Icons.error_outline, 'Error: $errorMsg');
  }

  Widget _buildEmptySearch() {
    return _buildErrorWidget(Icons.search_off_rounded, 'No results found.');
  }
}
